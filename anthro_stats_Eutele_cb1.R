...
#animals in Eutele clade 
MyTaxa <- c("Antennarius_striatus", "Opsanus_pardus", "Tylosurus_crocodilus_crocodilus", "Esox_lucius", "Lophius_americanus", 
             "Brotula_barbata", "Oncorhynchus_kisutch", "Oncorhynchus_mykiss", "Salmo_salar", "Sebastes_norvegicus", 
             "Prionotus_scitulus", "Prionotus_scitulus")
...
MyData <- read.csv("B_Euteleosts.csv")
MyData
str(MyData)
...
MyTree <- read.tree(file = "Rabosky_et_al_timetree.tre")
MyData2 <- read.csv("B_Euteleosts.csv")
str(MyData2)
