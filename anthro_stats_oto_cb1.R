...
#animals in "Otocephala clade 
MyTaxa <- c("Ariopsis_felis", "Bagre_marinus", "Catostomus_commersonii", "Ictiobus_bubalus", "Moxostoma_erythrurum", 
             "Serrasalmus_elongatus", "Alosa_sapidissima", "Brevoortia_patronus", "Myloplus_planquettei", "Hypophthalmichthys_nobilis",
             "Cyprinus_carpio_carpio", "Electrophorus_electricus", "Ameiurus_nebulosus", "Pylodictis_olivaris", "Ictalurus_punctatus", 
